...
object TestData {
  ...
  object Ninos {
    ...
    val ninoWithLOA1Spaces: String                     =
      ninoWithLOA1.substring(0, 2) + " " + ninoWithLOA1.substring(2, 4) + " " + ninoWithLOA1.substring(
        4,
        6
      ) + " " + ninoWithLOA1.substring(6, 8) + " " + ninoWithLOA1.substring(8, 9)
    val ninoHappyPath: String                          = ninos(9)
    val ninoHappyPathWithSpaces: String                =
      ninoHappyPath.substring(0, 2) + " " + ninoHappyPath.substring(2, 4) + " " + ninoHappyPath.substring(
        4,
        6
      ) + " " + ninoHappyPath.substring(6, 8) + " " + ninoHappyPath.substring(8, 9)
