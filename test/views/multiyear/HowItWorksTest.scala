...
class HowItWorksTest extends BaseTest with ViewTestUtils {
  ...
  val lowerTresholdScotland: String =
  ...
  "How it works" should {
    ...
    "display correct lede section" in {
      val line1 =
        s"Marriage Allowance lets you transfer £$maxAllowedTransfer of your Personal Allowance to your husband, wife or civil partner if your income is lower than theirs. This can reduce their tax by up to £$maxBenefit this tax year (6 April to 5 April the next year)."
    ...
    "display correct eligibility section" in {
      ...
      val line2      =
        s"If you live in Scotland, your partner must pay the starter, basic or intermediate rate, which usually means their income is between £$lowerTresholdScotland and £$maxLimitScotland."
      ...
      shouldHaveText(
        "be-lowest-income",
        s"your income must be lower than your partner’s and less than £$personalAllowance"
      )
      shouldHaveText(
        "earn-below-max-threshold",
        s"your partner’s income must be less than £$maxLimit in the current tax year"
      )
