...
class PartnersDetailsTest extends BaseTest with NinoGenerator {
  ...
  "Transfer page" should {
    "display the correct page title of transfer page" in {
      ...
      val document =
        Jsoup.parse(partnersDetailsView(transferForm.recipientDetailsForm(LocalDate.now, Nino(nino)), true).toString())
  ...
  "Calling Transfer Submit page" should {
    ...
    "display form error message (first name and last name missing from request)" in {
      ...
      document.getElementsByAttribute("action").toString               should include(
        "/marriage-allowance-application/partners-details"
      )
  ...
  "Calling Transfer Submit page with error in name field" should {
    ...
    "display form error message (first name contains more than 35 characters)" in {
      ...
      document
        ...
        .text()                                                      shouldBe "Error: Your partner’s first name must be 35 characters or less"
    }
    ...
    "display form error message (first name contains numbers)" in {
      ...
      document
        .getElementById("name-error")
        .text()                                                      shouldBe "Error: Your partner’s first name must only include letters a to z and hyphens"
    }
    ...
    "display form error message (last name contains more than 35 characters)" in {
      ...
      document
        ...
        .text()                                                      shouldBe "Error: Your partner’s last name must be 35 characters or less"
    }
    ...
    "display form error message (last name contains numbers)" in {
      ...
      document
        .getElementById("last-name-error")
        .text()                                                      shouldBe "Error: Your partner’s last name must only include letters a to z and hyphens"
    }
