  ...
  "DivorceEndExplanationViewModel" should {
    ...
    "create a view model" when {
      ...
      "a Recipient is divorced in the current tax year" in {
        ...
        val expectedViewModel = DivorceEndExplanationViewModel(
          formatDate(divorceDateCurrentTaxYear),
          expectedTaxYearStatus,
          expectedBulletStatements
        )
      ...
      "a Recipient is divorced in a previous tax year" in {
        ...
        val expectedViewModel = DivorceEndExplanationViewModel(
          formatDate(divorceDatePreviousTaxYear),
          expectedTaxYearStatus,
          expectedBulletStatements
        )
