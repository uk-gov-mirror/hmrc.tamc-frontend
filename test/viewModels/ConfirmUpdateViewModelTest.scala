...
class ConfirmUpdateViewModelTest extends BaseTest {
  ...
  val emailRow                     = SummaryRow(
    ...
    "change email",
    email,
    Some("/marriage-allowance-application/confirm-email"),
    3
  )
  ...
  def createConfirmationUpdateAnswers(
    loggedInUser: LoggedInUserInfo = loggedInUser,
