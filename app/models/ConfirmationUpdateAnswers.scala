...
case class ConfirmationUpdateAnswers(
  loggedInUserInfo: LoggedInUserInfo,
  divorceDate: Option[LocalDate],
  email: String,
  maEndingDates: MarriageAllowanceEndingDates
)
...
case class ConfirmationUpdateAnswersCacheData(
  relationshipRecords: Option[RelationshipRecords],
  divorceDate: Option[LocalDate],
  email: Option[String],
  maEndingDates: Option[MarriageAllowanceEndingDates]
)
