...
case class RelationshipRecords(
  primaryRecord: RelationshipRecord,
  nonPrimaryRecords: Seq[RelationshipRecord],
    ...
    primaryRecord.role match {
      case Transferor =>
        RecipientInformation(
          primaryRecord.otherParticipantInstanceIdentifier,
          primaryRecord.otherParticipantUpdateTimestamp
        )
